...
var ensureTableDDLs = []string{
	...
	// Multi-AI settlement evidence and per-model audit trail.
	...
	strategy_buy_amount_bkc VARCHAR(78) NULL,
	strategy_confidence_min DECIMAL(7,6) NULL,
	strategy_min_edge_percent DECIMAL(9,4) NULL,
	strategy_kelly_fraction DECIMAL(7,6) NULL,
	strategy_adaptive_cooldown BOOLEAN NULL,
	strategy_type VARCHAR(24) NOT NULL DEFAULT 'ai',
	strategy_direction VARCHAR(8) NOT NULL DEFAULT 'yes',
	strategy_grid_lower_percent DECIMAL(9,4) NULL,
	strategy_grid_upper_percent DECIMAL(9,4) NULL,
	strategy_grid_levels INT NULL,
	strategy_martingale_trigger_percent DECIMAL(9,4) NULL,
	strategy_martingale_multiplier DECIMAL(9,4) NULL,
	strategy_martingale_max_rounds INT NULL,
	created_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
	updated_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
	...
	reserve_yes VARBINARY(80) NULL,
	reserve_no VARBINARY(80) NULL,
	total_liquidity_shares VARBINARY(80) NULL,
	liquidity_fee_pool VARBINARY(80) NULL,
	updated_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
	PRIMARY KEY (contract_address, game_id),
	...
	my_liquidity_shares VARBINARY(80) NULL,
	my_liquidity_fees VARBINARY(80) NULL,
	updated_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
	...
	returned_yes_wei VARCHAR(78) NULL,
	returned_no_wei VARCHAR(78) NULL,
